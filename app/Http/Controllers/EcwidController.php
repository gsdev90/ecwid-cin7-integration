            ...
            $extractedData = array_map(function($order) {
                return [
                    ...
                    'shippingPerson' => isset($order['shippingPerson']) ? [
                        ...
                        'street' => isset($order['shippingPerson']['street']) ? $order['shippingPerson']['street'] : 'MissingStreetName',
                        'city' => isset($order['shippingPerson']['city']) ? $order['shippingPerson']['city'] : 'MissingCityName' ,
                    ...
                    'billingPerson' => isset($order['billingPerson']) ? [
                        ...
                        'street' =>  isset($order['billingPerson']['street']) ? $order['billingPerson']['street'] : 'MissingSttreetName',
                        'city' =>  isset($order['billingPerson']['city']) ? $order['billingPerson']['city'] : 'MissingCityName',
